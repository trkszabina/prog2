...
<html lang="en">
    ...
    ?>
        ...
        <?php
            ...
            if(isset($_POST['low']))
            {
                $sql = "SELECT name, price, link FROM mothersday order by price";
            ...
            if(isset($_POST['high']))
            {
                $sql = "SELECT name, price, link FROM mothersday order by price desc";
                $result = mysqli_query($conn, $sql);
            ...
            if(isset($_POST['name']))
            {
                $sql = "SELECT name, price, link FROM mothersday order by name";
                $result = mysqli_query($conn, $sql);
            ...
            { 
                $sql = "SELECT name, price, link FROM mothersday";
                $result = mysqli_query($conn, $sql);
...
$db = mysqli_connect('localhost', 'root', '', 'comments');
    ...
    echo '<form method="post" action="mw.php">
...
<?php
    ...
    <p>Now you can select your favourite item!</p>
        ...
        ';            
            $exists = mysqli_query($conn, "SELECT `name` FROM mothersday");
    ...
    if(isset($_POST['fav']))
    {
        ...
        $result = mysqli_query($conn,"SELECT * FROM mothersday");
