...
<html lang="en">
    ...
    ?>
        ...
        <?php
            ...
            if(isset($_POST['low']))
            {
                $sql = "SELECT name, price, link FROM birthdaymen order by price";
                ...
                {   
                        ...
                        <p> name:    $row[name]  </p>
                        <p> price:   $row[price] </p>
                        <a class='list' href='".$row['link']."' target=_blank
            ...
            if(isset($_POST['high']))
            {
                $sql = "SELECT name, price, link FROM birthdaymen order by price desc";
                $result = mysqli_query($conn, $sql);
            ...
            if(isset($_POST['name']))
            {
                $sql = "SELECT name, price, link FROM birthdaymen order by name";
                $result = mysqli_query($conn, $sql);
            ...
            { 
                $sql = "SELECT name, price, link FROM birthdaymen";
                $result = mysqli_query($conn, $sql);
...
$db = mysqli_connect('localhost', 'root', '', 'comments');
    ...
    echo '<form method="post" action="bm.php">

    <div class="input-group">
            <p>Please leave a comment or feedback!</p>
            <input id="valami" type="text" name="comment">
        </div>
        <br>
        <div class="input-group">
...
<?php
    ...
    <p>Now you can select your favourite item!</p>
        ...
        ';            
            $exists = mysqli_query($conn, "SELECT `name` FROM birthdaymen");
    ...
    if(isset($_POST['fav']))
    {
        ...
        $result = mysqli_query($conn,"SELECT * FROM birthdaymen");
