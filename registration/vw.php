...
<html lang="en">
    ...
    <?php
        echo 
        "<form method = 'post' action = 'vw.php'>
        <div class='dropdown' >
    ...
    ?>
        ...
        <?php
            ...
            if(isset($_POST['low']))
            {
                $sql = "SELECT name, price, link FROM valentineswomen order by price";
            ...
            if(isset($_POST['high']))
            {
                $sql = "SELECT name, price, link FROM valentineswomen order by price desc";
                $result = mysqli_query($conn, $sql);
            ...
            if(isset($_POST['name']))
            {
                $sql = "SELECT name, price, link FROM valentineswomen order by name";
                $result = mysqli_query($conn, $sql);
            ...
            { 
                $sql = "SELECT name, price, link FROM valentineswomen";
                $result = mysqli_query($conn, $sql);
...
$db = mysqli_connect('localhost', 'root', '', 'comments');
    ...
    echo '<form method="post" action="vw.php">
...
<?php
    ...
    <p>Now you can select your favourite item!</p>
        ...
        ';            
            $exists = mysqli_query($conn, "SELECT `name` FROM valentineswomen");
    ...
    if(isset($_POST['fav']))
    {
        ...
        $result = mysqli_query($conn,"SELECT * FROM valentineswomen");
