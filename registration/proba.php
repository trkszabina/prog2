...
<html lang="en">
    ...
    <?php
        echo 
        "<form method = 'post' action = 'cw.php'>
        <div class='dropdown' >
    ...
    ?>
        ...
        <?php
            ...
            if(isset($_POST['low']))
            {
                $sql = "SELECT name, price, link FROM christmaswomen order by price";
            ...
            if(isset($_POST['high']))
            {
                $sql = "SELECT name, price, link FROM christmaswomen order by price desc";
                $result = mysqli_query($conn, $sql);
            ...
            if(isset($_POST['name']))
            {
                $sql = "SELECT name, price, link FROM christmaswomen order by name";
                $result = mysqli_query($conn, $sql);
            ...
            { 
                $sql = "SELECT name, price, link FROM christmaswomen";
                $result = mysqli_query($conn, $sql);
...
$db = mysqli_connect('localhost', 'root', '', 'comments');
    ...
    echo '<form method="post" action="cw.php">
...
<?php
    ...
    <p>Now you can select your favourite item!</p>
        <select name="selected_gift">
            <option disabled>Valami</option>
        ';            
            $exists = mysqli_query($conn, "SELECT `name` FROM christmaswomen");
    ...
    if(isset($_POST['fav']))
    {
        ...
        $result = mysqli_query($conn,"SELECT * FROM christmaswomen");
   ...
   <?php
    ...
    '
    <form method="post">
    <p>If you changed your mind, you can delete any item!</p>
        <select name="selected_gift">
            <option disabled>Valami</option>
        ';            
            $exists = mysqli_query($conn, "SELECT `name` FROM christmaswomen");
        ...
        <div class="input-group">
            <button type="submit" class="btn" name="fav">Delete the item</button>
        </div>
    </form>
    ';
    ...
    if(isset($_POST['fav']))
    {
        ...
        $sql = "DELETE FROM fav_items WHERE username='".$_SESSION['username']."'";
