...
<html lang="en">
    ...
    <?php
        echo 
        "<form method = 'post' action = 'bw.php'>
        <div class='dropdown' >
    ...
    ?>
        ...
        <?php
            ...
            if(isset($_POST['high']))
            {
                $sql = "SELECT name, price, link FROM birthdaywomen order by price desc";
                $result = mysqli_query($conn, $sql);
            ...
            if(isset($_POST['name']))
            {
                $sql = "SELECT name, price, link FROM birthdaywomen order by name";
                $result = mysqli_query($conn, $sql);
            ...
            { 
                $sql = "SELECT name, price, link FROM birthdaywomen";
                $result = mysqli_query($conn, $sql);
...
$db = mysqli_connect('localhost', 'root', '', 'comments');
    ...
    echo '<form method="post" action="bw.php">
...
<?php
    ...
    <p>Now you can select your favourite item!</p>
        ...
        ';            
            $exists = mysqli_query($conn, "SELECT `name` FROM birthdaywomen");
    ...
    if(isset($_POST['fav']))
    {
        ...
        $result = mysqli_query($conn,"SELECT * FROM birthdaywomen");
